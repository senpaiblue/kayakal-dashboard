...
replacements = [
    (re.compile(r'\bwrm ii\b', re.IGNORECASE), 'Wire Rod Mill II'),
    (re.compile(r'\bwrm 2\b', re.IGNORECASE), 'Wire Rod Mill II'),
    (re.compile(r'\bwrm2\b', re.IGNORECASE), 'Wire Rod Mill II'),
    (re.compile(r'\bwrm-2\b', re.IGNORECASE), 'Wire Rod Mill II'),
    (re.compile(r'\bwrm #2\b', re.IGNORECASE), 'Wire Rod Mill II'),
    (re.compile(r'\bwrm#2\b', re.IGNORECASE), 'Wire Rod Mill II')
]
