...
replacements = [
    (re.compile(r'\bhsm ii\b', re.IGNORECASE), 'Hot Strip Mill II'),
    (re.compile(r'\bhsm 2\b', re.IGNORECASE), 'Hot Strip Mill II'),
    (re.compile(r'\bhsm2\b', re.IGNORECASE), 'Hot Strip Mill II')
]
