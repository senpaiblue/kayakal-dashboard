...
replacements = [
    (re.compile(r'\bcrm i\b', re.IGNORECASE), 'Cold Rolling Mill I'),
    (re.compile(r'\bcrm 1\b', re.IGNORECASE), 'Cold Rolling Mill I'),
    (re.compile(r'\bcrm1\b', re.IGNORECASE), 'Cold Rolling Mill I')
]
